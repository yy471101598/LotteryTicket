...
import wy.com.ticket.ui.home.HomeActivity;
...
public class HostActivity extends TabActivity implements OnClickListener {
    ...
    private RelativeLayout li_tab_home, li_tab_me;
    private ImageView img_home, img_me;
    private TextView tv_home, tv_me;
    private Activity ac;
...
//		update();
    ...
    private void initLocaleLanguage() {
        ...
        String language = PreferenceHelper.readString(getApplicationContext(), "juhepay", "lagavage", "vi");
...
//	}
    ...
    private void resetTab() {
        // TODO Auto-generated method stub
        img_home.setBackgroundResource(R.mipmap.home_not);
        img_me.setBackgroundResource(R.mipmap.me_not);

        tv_home.setTextColor(getResources().getColor(R.color.text49));
        tv_me.setTextColor(getResources().getColor(R.color.text49));
    ...
    private void selectTab(int i) {
        switch (i) {
            case 1:
                ...
                tv_home.setTextColor(getResources().getColor(R.color.text_yellow));
                break;
            case 2:
                resetTab();
                tabhost.setCurrentTabByTag(TAB_ME);
                img_me.setBackgroundResource(R.mipmap.me_true);
                tv_me.setTextColor(getResources().getColor(R.color.text_yellow));
                break;
        }
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {
            ...
            if (secndTime - firstTime > 3000) {
                firstTime = secndTime;
                Toast.makeText(HostActivity.this, "再按一次退出", Toast.LENGTH_LONG)
                        .show();
            } else {
                ActivityStack.create().AppExit(ac);
            }
