...
public class ShowCaipiaoNumberDialog {
    public static Dialog tishiDialog(final Context context,
                                     int showingLocation, List<BuyCaipiao> list) {
        final Dialog dialog;
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.dialog_look_ballnum, null);
        RelativeLayout rl_back = (RelativeLayout) view.findViewById(R.id.rl_down);
        ListView listView = (ListView) view.findViewById(R.id.listview);
        ShowCaipiaoNumberAdapter adapter = new ShowCaipiaoNumberAdapter(context, list);
